...
const Section = ({
  ...
  return (
    <div
      className={clsx(
        "min-h-screen flex flex-col md:py-0 md:gap-0 gap-10 py-10 md:flex-row w-full items-center justify-center lg:px-44 md:px-36 sm:px-7 px-4",
        className
      )}
    >
      ...
      <section className="flex-1 about-image flex items-center justify-center">
        <Image
          ...
          className="md:w-1/2 w-11/12 border-[#2f2d51] border rounded-2xl"
          width={1179}
          height={2369}
        />
      </section>
