...
const Page = () => {
  return (
    <div className="lg:px-24 md:px-16 space-y-1 leading-7 sm:px-7 px-4 mt-32">
      ...
      <h3 style={{ marginBottom: 5 }}>Table of Contents</h3>
      <ol className="list-decimal">
        ...
        <li style={{ textDecoration: "none" }}>
          <a href="#generated">USER GENERATED CONTRIBUTIONS</a>
        </li>
        <li style={{ textDecoration: "none" }}>
          <a href="license">CONTRIBUTION LICENSE</a>
        </li>
        <li style={{ textDecoration: "none" }}>
          <a href="#guidelines">GUIDELINES FOR REVIEWS</a>
        </li>
        <li style={{ textDecoration: "none" }}>
          <a href="#mobile-license">MOBILE APPLICATION LICENSE</a>
        </li>
        <li style={{ textDecoration: "none" }}>
          <a href="#service-management">SERVICES MANAGEMENT</a>
        </li>
        <li style={{ textDecoration: "none" }}>
          <a href="#privacy-policy">PRIVACY POLICY</a>
        </li>
        <li style={{ textDecoration: "none" }}>
          <a href="#copyright">COPYRIGHT INFRINGEMENTS</a>
        </li>
        <li style={{ textDecoration: "none" }}>
        ...
        <li style={{ textDecoration: "none" }}>
          <a href="residents">CALIFORNIA USERS AND RESIDENTS</a>
        </li>
        <li style={{ textDecoration: "none" }}>
      ...
      <h4 id="our-services">1. OUR SERVICES</h4>
      <p>
      ...
      <h5 id="intellectual">Our intellectual property</h5>
      <p>
      ...
      <p>
        ...
        address your request to: arzsahag@gmail.com. If we ever grant you the
      ...
      <br />
      <h4 id="registration">4. USER REGISTRATION</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="purchases">6. PURCHASES AND PAYMENT</h4>
      <br />
      ...
      <p>
        ...
        change prices at any time. All payments shall be in US dollars. You
        agree to pay all charges at the prices then in effect for your purchases
      ...
      <br />
      <h4 id="subscriptions">7. SUBSCRIPTIONS</h4>
      <br />
      ...
      <p>
        ...
        Services, please email us at arzsahag@gmail.com.
      </p>
      <br />
      <h5>Fee Changes</h5>
      <br />
      ...
      <br />
      <h4 id="refunds">8. REFUNDS POLICY</h4>
      <br />
      <p>All sales are final and no refund will be issued.</p>
      <br />
      <h4 id="prohibited">9. PROHIBITED ACTIVITIES</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="generated">10. USER GENERATED CONTRIBUTIONS</h4>
      <p>
      ...
      <h4 id="license">11. CONTRIBUTION LICENSE</h4>
      <p>
        ...
        through any media channels. This license will apply to any form, media,
        or technology now known or hereafter developed, and includes our use of
      ...
      <br />
      <h4 id="guidelines">12. GUIDELINES FOR REVIEWS</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="mobile-license">13. MOBILE APPLICATION LICENSE</h4>
      <br />
      <h5>Use License</h5>
      <br />
      <p>
      ...
      <br />
      <h4 id="privacy-policy">15. PRIVACY POLICY</h4>
      <br />
      <p>
        We care about data privacy and security. Please review our Privacy
        Policy: https://www.prayse.app/privacy. By using the Services, you agree
      ...
      <br />
      <h4 id="copyright">16. COPYRIGHT INFRINGEMENTS</h4>
      <br />
      <p>
        We respect the intellectual property rights of others. If you believe
        that any material available on or through the Services infringes upon
      ...
      <br />
      <h4 id="modifications">18. MODIFICATIONS AND INTERRUPTIONS</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="governing">19. GOVERNING LAW</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="dispute">20. DISPUTE RESOLUTION</h4>
      <br />
      ...
      <p>
        ...
        pending arbitration, or to confirm, modify, vacate, ol enter judgment on
      ...
      <p>
        ...
        Legal Terms. If this provision is found to be illegal or unenforceable,
      ...
      <br />
      <h4 id="corrections">21. CORRECTIONS</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="disclaimer">22. DISCLAIMER</h4>
      <br />
      <p>
        ...
        AND/OF FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR
      ...
      <br />
      <h4 id="limitations">23. LIMITATIONS OF LIABILITY</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="indemnification">24. INDEMNIFICATION</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="user-data">25. USER DATA</h4>
      <br />
      <p>
        ...
        action against us arising from any such los: or corruption of such data.
      </p>
      <br />
      <h4 id="communications">
      ...
      <p>
        ...
        communications, and you agree tha all agreements, notices, disclosures,
      ...
      <br />
      <h4 id="residents">27. CALIFORNIA USERS AND RESIDENTS</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="miscellaneous">28. MISCELLANEOUS</h4>
      <br />
      <p>
      ...
      <br />
      <h4 id="contact-us">29. CONTACT US</h4>
      <br />
      <p>
      ...
      <br />
      <ul>
        <li style={{ listStyle: "none" }}>Sahak Arzoumanian</li>
        <li style={{ listStyle: "none" }}>2213 Rockrose Street</li>
        <li style={{ listStyle: "none" }}>Palmdale, CA 93551</li>
        <li style={{ listStyle: "none" }}>United States</li>
        <li style={{ listStyle: "none" }}>Phone: 6613000021</li>
        <li style={{ listStyle: "none" }}>arzsahag@gmail.com</li>
        <li style={{ listStyle: "none" }}>By email: arzsahag@gmail.com</li>
      </ul>

      <br />
      <span>Generated using Termly</span>
    </div>
  );
};
