    ...
    <div className="min-h-screen my-24 lg:px-44 flex flex-col items-center md:px-36 sm:px-7 px-4">
      ...
      <div className="md:w-2/3 mt-5 space-y-3">
        <p>
          ...
          New Life Church. The study reached a point where the teacher began
          taking prayer requests. As everyone shared their requests, we
          struggled to find pens and papers to write them down, so some resorted
          to using their phones.
        </p>
        <p>
        ...
        <p>
          ...
          and what God has done and is continuing to do is honestly amazing. I
          can&apos;t find the words to describe how Prayse has been a blessing
          to others and also to me. Beyond the numbers and statistics, the thing
          that sticks with me the most is the little comments I receive about
          Prayse. If you&apos;ve interacted with me regarding Prayse or left a
          comment on our online platforms, know that you&apos;ve made a
          significant impact. The current and future accomplishments of Prayse
          are not only fruit unto my account, but also yours.
        </p>
        ...
        <p>
          ...
          your Lord and Saviour. Close your eyes, and say this: Dear Lord,
          I&apos;m here. Please forgive me from my sins, and help me to abide in
          You, as You abide in me. From this point on, my life is Yours. Help me
          to live a life that glorifies You, and reflects Your love and grace to
