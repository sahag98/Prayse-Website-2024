  ...
  return (
    <div className="container-standard space-y-1 leading-7 mt-32">
      ...
      <ul className="list-disc">
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Prayse, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Sahak Arzoumanian, 2213 rockrose street
            palmdale, ca 93551.
          </p>
        </li>
        <li>
      ...
      <h4 className="font-medium mt-2">Usage Data</h4>
      <p>
      ...
      <p>
        ...
        be simply stored on Your device. You can enable or disable access to
        this information at any time, through Your Device settings.
      </p>
      ...
      <h3 className="text-lg font-semibold mt-2">Delete Your Personal Data</h3>
      <p>
      ...
      <h4 className="font-medium mt-2">Business Transactions</h4>
      <p>
      ...
      <h4 className="font-medium mt-2">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="font-medium mt-2">Other legal requirements</h4>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-2">Children&apos;s Privacy</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-2">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-2">Contact Us</h2>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.prayse.app/privacy"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.prayse.app/privacy
          </a>
        </li>
      </ul>
    </div>
